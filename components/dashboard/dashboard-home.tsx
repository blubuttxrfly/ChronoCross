  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <section className="mb-10 grid gap-6 lg:grid-cols-[1fr_320px]">
        {/* Main Hero Card */}
        <div className="relative overflow-hidden rounded-3xl border border-[#e6dfd4] bg-gradient-to-br from-[#fbf7ef] to-[#f5f0e8] p-8 shadow-sm">
          <div className="relative z-10 max-w-2xl">
            ...
            <h1 className="mt-5 text-4xl font-semibold leading-tight tracking-tight text-[#16241d] sm:text-5xl">
              Find help nearby. Pay with hours.
            </h1>
            <p className="mt-4 text-base leading-relaxed text-[#646860]">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="mt-3 flex items-baseline gap-2">
                  <p className="text-5xl font-semibold tracking-tight">₡{HOUR_BALANCE.current}</p>
      ...
      <section className="mb-10 grid gap-8 lg:grid-cols-[1fr_360px]">
        {/* Requests Column */}
        <div>
          <SectionHeader
